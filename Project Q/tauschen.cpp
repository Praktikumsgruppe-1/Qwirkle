...
void Tauschen::SteinTauschen(){
    ...
    if( istGleich == false && !Game::beutelStackForm.empty() )
    {
        ...
        //qDebug() << "Ende Tauschen: alter Stein  " << getFormPixmap( undoClass::undoPixmap.top() ) << getFarbePixmap( undoClass::undoPixmap.top() );
        //qDebug() << "Ende Tauschen: neuer Stein  " << Game::beutelStackFarbe.back() << Game::beutelStackFarbe.back();
    }
